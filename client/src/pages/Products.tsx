    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-7xl">
          <div className="grid md:grid-cols-2 gap-8">
            {/* NEON Original */}
            <div className="bg-[#0a0a0a] border border-[#c8ff00]/30 rounded-xl overflow-hidden">
              <div className="bg-gradient-to-b from-[#c8ff00]/20 to-transparent p-8 text-center">
                ...
                />
                <h3 className="text-4xl font-black text-[#c8ff00] mb-2">
                  NEON ORIGINAL
                </h3>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-[#c8ff00] mt-0.5 flex-shrink-0" />
            ...
            {/* NEON Organic */}
            <div className="bg-[#0a0a0a] border border-orange-500/30 rounded-xl overflow-hidden">
              <div className="bg-gradient-to-b from-orange-500/20 to-transparent p-8 text-center">
                <div className="w-48 h-64 mx-auto mb-6 bg-gradient-to-b from-orange-400/20 to-transparent rounded-lg flex items-center justify-center">
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-[#0a0a0a] to-black">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[#0a0a0a] border border-[#c8ff00]/20 rounded-lg p-6">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-2xl text-center space-y-6">
          <h3 className="text-4xl font-bold text-white">
            Ready to <span className="text-[#c8ff00]">Pre-Order?</span>
          </h3>
